...
/*
Bayesian Linear Regression Kernel used for Fabolas
*/

class BayesianLinearRegressionKernel : public Kernel {
public:
    BayesianLinearRegressionKernel (
        double log_a,
        double log_b,
        size_t ndim,
        size_t naxes
    ...
    double get_parameter (size_t i) const {
        if (i == 0) return param_log_a_;
        if (i == 1) return param_log_b_;
        return 0.0;
    };
    void set_parameter (size_t i, double value) {
        if (i == 0) {
    ...
    void update_reparams () {
        reparam_a_ = get_reparam_a (
            param_log_a_,param_log_b_
        );
        reparam_b_ = get_reparam_b (
            param_log_a_,param_log_b_
        );
        
    };

    double get_reparam_a (
        double log_a,double log_b
    ) {
        return exp(log_a);
    }
    double get_reparam_b (
        double log_a,double log_b
    ) {
        return exp(log_b);
    }
